...
let contadorMultiplos = 3;

console.log("Ejercicio 6");

while (contadorMultiplos < 30) {
...
let contadorFactorial = 5;
let factorial = 1;

console.log("Ejercicio 7");

while (contadorFactorial >= 1) {
  factorial = contadorFactorial * factorial;
  contadorFactorial--;
}
...
while (true) {
  ...
  if (numeroDivisible % 7 == 0 && numeroDivisible % 11 == 0) {
    console.log(`El primer número divisible por 7 y por 11 es: ${numeroDivisible}`);
    break;
  }
  numeroDivisible++;
}
